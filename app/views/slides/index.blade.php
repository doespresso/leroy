...
<div class="slides-container" id="main" style="display:block; width:100%; max-width:100%">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="@if (!empty($slide->img))background-image: url({{url("/")}}/uploads/sliders/published/{{$slide->img}}); @endif @if (!empty($slide->bg_color))background-color: {{$slide->bg_color}}; @endif">
